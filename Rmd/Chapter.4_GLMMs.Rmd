...
```{r}
relaciones <- ~nspp+Tmax+dsh+prep_smn+dia+ca_h+ca_s+np_w+np_h+np_wo+np_s+cv
pairs(relaciones, data=au)
...
scatterplotMatrix(relaciones, data=au, pch=19, cex=0.2, cex.lab=3, cex.axis=1.5, diagonal=TRUE, col="red", 
                  col.axis='black', regLine=list(method=lm, col="blue", lwd=2), smooth=TRUE,
                  main="Pearson corraletion coefficient", lower.panel=panel.cor)
```
